var fightOrSkip = function () {
    ...
    if (promptFight === "" || promptFight === null) {
        ...
        return fightOrSkip(); // why not just call the function instead of return???
    }
...
var fight = function (enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        // Subtract the value of 'damage' from the value of 'playerInfo.health' and use that results to update the value in the 'playerInfo.health' variable
...
var startGame = function () {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            // reset enemy.health befre starting new fight
...
var shop = function () {
    // as the player what they'd like to do
